...
<head>
    ...
    <!-- Agrega los estilos y scripts necesarios para el modal -->
        ...
        <table class="table">
            ...
            <tbody>
                <?php
                    ...
                    $sql = "SELECT  grupo, nombre, fecha_inicio, fecha_terminacion, 
                    inscritos, egresados, dias, horario, costo, periodo, observaciones FROM curso";
