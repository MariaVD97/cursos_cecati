...
$titulo = "Cursos Proximos a Terminar";
...
<head>
    ...
    <title>Tabla de Cursos Proximos</title>
...
<div class="container">
    ...
    echo "<h2 class='text-center mb-4'>$titulo</h2>";
            ...
            $contador = 1;
            $sql = "SELECT grupo, nombre, fecha_inicio, fecha_terminacion, inscritos, egresados, dias, horario, costo, periodo, observaciones FROM curso WHERE fecha_inicio <= CURDATE() AND fecha_terminacion >= CURDATE()";
            $result = $conn->query($sql);
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    echo "<tr style='background-color: rgb(245, 245, 171);'>";
                    echo "<td>" . $contador . "</td>";
