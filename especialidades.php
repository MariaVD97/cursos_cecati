...
<div class="container">
    <!-----------Cursos desde la base de datos conforme a su especialidad ---------------->
    <div class="row">
        ...
        <?php
            ...
            echo "<div><h2 class='text-center'>".$especialidad."</h2>";
        ?>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <?php
                ...
                // Se ejecutar la consulta
                $sql = "SELECT  grupo, nombre, fecha_inicio, fecha_terminacion,inscritos, egresados, dias, 
                horario, costo, periodo, observaciones FROM curso WHERE especialidad LIKE '%$especialidad%'";
